...
namespace MoldyPotatoes.ConsoleApp
{
   ...
   public class CustomConsole : ICustomConsole

    {
        ...
        // All Console.'s are here
        // Will invoke these methods in UI methods
        ...
        public void EnterStars()
        {
            ...
            Console.Write("Enter Number of Stars out of 10: ");
        ...
        public void PrintMovies(List<Movie> film)
        {

            foreach (Movie x in film)
            {
                PrintMovie(x);
            }
        ...
        {
            Console.WriteLine("Hate to see you go, see ya later.");
        }
    }
}